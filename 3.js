!(function(e, t) {
    ...
    function N(e, t, n) {
        for (
            var r, i = (nt[t] || []).concat(nt["*"]), s = 0, o = i.length; s < o; s++
        )
    ...
    function M(e, t, n) {
        for (var r, i, s, o, a = e.contents, u = e.dataTypes;
            "*" === u[0];)
            u.shift(),
    ...
    function O(e, t, n, r) {
        ...
        for (s = l.shift(); s;)
            if (
                (e.responseFields[s] && (n[e.responseFields[s]] = t), !u && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
                    (u = s),
                    (s = l.shift()))
            )
                if ("*" === s) s = u;
    ...
    Z.extend({
            ...
            map: function(e, t, r) {
                var i,
                    ...
                    u = [];
                if (a)
                    for (; s < o; s++)(i = t(e[s], s, r)), null != i && u.push(i);
                else
                    for (s in e)(i = t(e[s], s, r)), null != i && u.push(i);
                return V.apply([], u);
            },
            guid: 1,
            proxy: function(e, t) {
                ...
                return r !== D && 9 === r.nodeType && r.documentElement ?
                    ((D = r),
                        ...
                        (T.getById = i(function(e) {
                            return (
                                (R.appendChild(e).id = O), !r.getElementsByName || !r.getElementsByName(O).length
                            );
                        })),
                        T.getById ?
                ...
                function(e, t, n, r) {
                    ...
                    if (((n = n || []), 1 === d.length)) {
                        if (
                            ...
                            if (
                                ((t = (x.find.ID(o.matches[0].replace(Te, xe), t) || [])[0]), !t)
                            )
                                return n;
                            c && (t = t.parentNode), (e = e.slice(s.shift().value.length));
                        }
                        for (
                            i = fe.needsContext.test(e) ? 0 : s.length; i-- && ((o = s[i]), !x.relative[(a = o.type)]);
    ...
    Z.fn.extend({
        ...
        is: function(e) {
            return !!r(
                this,
                "string" == typeof e && se.test(e) ? Z(e) : e || [], !1
            ).length;
        },
    });
    var ue,
            ...
            closest: function(e, t) {
                for (
                    var n,
                        ...
                        s = [],
                        o =
                        se.test(e) || "string" != typeof e ? Z(e, t || this.context) : 0; r < i; r++
                )
    ...
    (Z.Callbacks = function(e) {
        ...
        var t,
            ...
            l = function(s) {
                for (
                    t = e.memory && s, n = !0, a = i || 0, i = 0, o = u.length, r = !0; u && a < o; a++
                )
    ...
    Z.extend({
        ...
        Z.fn.extend({
            ...
            promise: function(e, t) {
                ...
                for (
                    "string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; o--;
        ...
        trigger: function(t, n, r, i) {
            ...
            if (
                ...
                if (!i && !d.noBubble && !Z.isWindow(r)) {
                    for (
                        u = d.delegateType || p, Ae.test(u + p) || (o = o.parentNode); o; o = o.parentNode
                    )
                        h.push(o), (a = o);
                    a === (r.ownerDocument || K) &&
    ...
    Z.extend({
            ...
            buildFragment: function(e, t, n, r) {
                ...
                for (l.textContent = "", h = 0;
                    ...
                    if (
                        ...
                        for (c = 0;
                            (i = s[c++]);) He.test(i.type || "") && n.push(i);
                return l;
            },
            cleanData: function(e) {
                for (
                    var t, n, r, i, s = Z.event.special, o = 0; void 0 !== (n = e[o]); o++
                ) {
                    if (
                        Z.acceptData(n) &&
        ...
        Z.fn.extend({
            ...
            remove: function(e, t) {
                for (
                    var n, r = e ? Z.filter(e, this) : this, i = 0; null != (n = r[i]); i++
                )
            ...
            domManip: function(e, t) {
                ...
                if (
                    ...
                    if (s)
                        for (
                            a = i[i.length - 1].ownerDocument, Z.map(i, f), u = 0; u < s; u++
                        )
                            (o = i[u]),
                            He.test(o.type || "") &&
    ...
    Z.extend({
        ...
        Z.each({
            ...
            (Z.cssHooks[e + t] = {
                expand: function(n) {
                    for (
                        var r = 0, i = {}, s = "string" == typeof n ? n.split(" ") : [n]; r < 4; r++
                    )
        ...
        Z.extend({
            valHooks: {
                ...
                select: {
                    ...
                    set: function(e, t) {
                        for (
                            var n, r, i = e.options, s = Z.makeArray(t), o = i.length; o--;
                    ...
                    T = {
                        ...
                        getResponseHeader: function(e) {
                            ...
                            if (2 === y) {
                                if (!o)
                                    for (o = {};
                                        (t = pt.exec(s));) o[t[1].toLowerCase()] = t[2];
                                t = o[e.toLowerCase()];
                            }
    ...
    Z.fn.extend({
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (
                        var e = this.offsetParent || Ht; e && !Z.nodeName(e, "html") && "static" === Z.css(e, "position");
    ...
    (t.load = function() {
        ...
        null != this._request.addEventListener ?
            (this._request.addEventListener(
                    "loadstart",
                    this._handleLoadStartProxy, !1
                ),
                this._request.addEventListener(
                    "progress",
                    this._handleProgressProxy, !1
                ),
                ...
                this._request.addEventListener(
                    "timeout",
                    this._handleTimeoutProxy, !1
                ),
                this._request.addEventListener("load", this._handleLoadProxy, !1),
                this._request.addEventListener(
                    "readystatechange",
                    this._handleReadyStateChangeProxy, !1
                )) :
    ...
    Object.defineProperty(n, "volume", {
            ...
            set: function(e) {
                ...
                if (
                    ((e = Math.max(0, Math.min(1, e))),
                        (n._masterVolume = e), !this.activePlugin ||
        ...
        Object.defineProperty(n, "muted", {
            ...
            set: function(e) {
                if (null == e) return !1;
                if (
                    ((this._masterMute = e), !this.activePlugin ||
        ...
        (n.removeSound = function(e, r) {
            ...
            return (
                ...
                n.activePlugin.removeSound(e), !0
            );
        }),
        ...
        if (null != e) {
            e.pause(),
                ...
                e.removeEventListener(
                    ...
                    this._readyHandler, !1
                ),
                e.removeEventListener(
                    createjs.HTMLAudioPlugin._AUDIO_STALLED,
                    this._stalledHandler, !1
                ),
                e.removeEventListener(
                    createjs.HTMLAudioPlugin._AUDIO_SEEKED,
                    this._loopHandler, !1
